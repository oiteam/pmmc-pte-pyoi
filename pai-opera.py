...
from pmmc.pte.pai.opera import loadConfig, saveConfig, setArgParserDefaults, launch
...
populateArgParser(parser, pai.opera.ARGPARSER_TITLE, pai.opera.ARGPARSER_DATA)
...
launch(args.activity, args.page, args.kiosk, args.local, args.server, args.verbose)
